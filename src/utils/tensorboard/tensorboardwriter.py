...
class TensorBoardWriter():
    ...
    def write_image_test_results(self, images, true_labels, predictions, step, runmode, dataSubset):
        ...
        overlaid_images = imageutils.overlay_predictions(pil_images, true_labels.cpu().tolist(), predictions.cpu().tolist(), datasetutils.get_dataset_tag_mappings(self.config))
