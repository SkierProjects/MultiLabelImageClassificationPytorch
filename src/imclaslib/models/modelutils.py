...
def get_learningRate_scheduler(optimizer, config):
    ...
    """
    return ReduceLROnPlateau(optimizer, mode='min', factor=config.train_learningrate_reducer_factor, patience=config.train_learningrate_reducer_patience, threshold=config.train_learningrate_reducer_threshold, min_lr=config.train_learningrate_reducer_min_lr)